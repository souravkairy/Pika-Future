...
<div class="cd-overlay"></div>
        ...
        $('#euro').on('keyup change',function(){
            $('#taka').val($(this).val() * $('#rate').val());
            $('#total').val((+$(this).val()) + (+$('#crg').val()));

            });
        });
        $(document).ready (function(){
        $('#taka').on('keyup change',function(){
            $('#euro').val($(this).val() /  $('#rate').val());
            $('#total').val((+$('#euro').val()) + (+$('#crg').val()));
            });
        });
        </script>
        <script>
