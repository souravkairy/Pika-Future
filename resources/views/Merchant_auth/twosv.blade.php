            ...
            <div class="row">
                <div class="col-md-3 center">
                    <div class="login-box">
                        ...
                        <form class="m-t-md" method="POST" action="{{url('cktwofauth')}}">
                            @csrf
                            <div class="form-group">
                                <input type="hidden" name="twofauth" value="{{$twofauth}}">
                                <input type="hidden" name="m_username" value="{{$user_name}}">
                                <input type="hidden" name="m_password" value="{{$user_password}}">
