                    ...
                    <div class="col-md-3 center">
                      ...
                      @endif
                        ...
                        <div class="login-box">
                            ...
                            <form class="m-t-md" action="{{url('check_merchant')}}" method="POST">
                            @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="User Name" name="m_username" required>
                                </div>
                                <div class="form-group">
                            ...
                            <a href="{{url('merchant_forgotPass')}}" class="display-block text-center m-t-md text-m">Forgot Password?</a>
